...
class MudServerFeatureUnavailableError(Exception):
...
class MudServerClient:
    ...
    def generate_condition_axis_payload(
        self,
        *,
        world_id: str,
        seed: int | None = None,
        ...
        The canonical mud-server route requires ``session_id`` in query params
        plus strict runtime inputs in the JSON body under ``inputs.entity``.
