...
export const dom = {
  ...
  pipelineSessionBadge:      $("pipeline-session-badge"),
  pipelineModeText:          $("pipeline-mode-text"),
  pipelineWorldSelect:       $("pipeline-world-select"),
  pipelineWorldRefresh:      $("pipeline-world-refresh"),
  pipelineWorldSourceHint:   $("pipeline-world-source-hint"),
  pipelineWorldConfig:       $("pipeline-world-config"),
  pipelinePolicyBundleDetails: $("pipeline-policy-bundle-details"),
  pipelinePolicySourceHint:  $("pipeline-policy-source-hint"),
  pipelinePolicyRefresh:     $("pipeline-policy-refresh"),
  pipelinePolicyViewFile:    $("pipeline-policy-view-file"),
  pipelinePolicySourceBadge: $("pipeline-policy-source-badge"),
  ...
  pipelineAxisLoadPreset:    $("pipeline-axis-load-preset"),
  pipelineAxisPresetSourceHint: $("pipeline-axis-preset-source-hint"),
  pipelineAxisManualPanel:   $("pipeline-axis-manual-panel"),
  pipelineAxisJson:          $("pipeline-axis-json"),
  pipelineAxisRelabel:       $("pipeline-axis-relabel"),
  pipelineBlockSelectionSummary: $("pipeline-block-selection-summary"),
  pipelineDescriptorToneSummary: $("pipeline-descriptor-tone-summary"),
  pipelineWorldContextInput: $("pipeline-world-context-input"),
  pipelineOccupationSignalsInput: $("pipeline-occupation-signals-input"),
  pipelineModelIdInput:      $("pipeline-model-id-input"),
  pipelineAspectRatioInput:  $("pipeline-aspect-ratio-input"),
  pipelineSeedInput:         $("pipeline-seed-input"),
  pipelineCompileRequest:    $("pipeline-compile-request"),
  pipelineCompositionPreview: $("pipeline-composition-preview"),
  pipelineCompileButton:     $("pipeline-compile-button"),
  pipelineCompileResult:     $("pipeline-compile-result"),
  pipelineCopyResponseJson:  $("pipeline-copy-response-json"),
  pipelineExportResponseJson: $("pipeline-export-response-json"),
  ...
  pipelinePolicyFileModal:   $("pipeline-policy-file-modal"),
  pipelinePolicyFileModalBackdrop: $("pipeline-policy-file-modal-backdrop"),
  pipelinePolicyFileModalCloseX: $("pipeline-policy-file-modal-close-x"),
  pipelinePolicyFileModalClose: $("pipeline-policy-file-modal-close"),
  pipelinePolicyFileModalContent: $("pipeline-policy-file-modal-content"),
